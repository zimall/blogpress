 ...
 *
 * Carabiner requires the JSMini {@link http://codeigniter.com/forums/viewthread/103039/ released here}
	...
	private function _minify($flag, $file_ref)
	{
		...
		switch($flag){
			...
			case 'js':
				...
				return $this->CI->jsmini->minify($contents);
        ...
        private function _display_js_string($group='main'){
			...
			return;
                ...
                if($this->minify_js && strlen($script)){
                    ...
                    $script = $this->CI->jsmini->minify($script);
                }
