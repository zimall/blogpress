...
<div class="col-sm-12">
	<div class="panel-body alert alert-warning" style="color: #555;">
		<div class="col-sm-6 text-center" style="border-right: 1px solid #ccc;">
			<h1 class="" style="font-size:13em;text-align:center;">
				<span class="radmin radmin-cancel" style="font-size:0.8em;"></span>
				<span>400</span>
			</h1>
			<h2>
				Bad Request! <span class="fa fa-hand-paper-o"></span>
			</h2>
		</div>
		<div class="col-sm-6">
			<h2><?=$sad_title;?></h2>
			...
			<ol class="options-403">
				...
				<!-- <li><?php echo safe_mailto( $this->config->item('system-support-email'), 'Get Help' );?></li> -->
			</ol>
		</div>
		<!-- col-sm-6 -->
	</div>
