...
*/
$baseUrl = 'http://www.dblprime.com/images/articles/files/';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'jpeg,jpg,png,gif,bmp,pdf,doc,docx,ppt,pptx,xls,xlsx,mp3,mp4,flv,ods,odt',
		'deniedExtensions' => '');
...
*/
$config['HideFolders'] = Array(".svn","CVS",'users','company_profiles','mms', 'upload', '_thumbs', 'email', 'products', 'invoices',
							'list_images','page_banners', 'shop_banners');
