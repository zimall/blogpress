...
let sendB=function(e){if(!navigator.sendBeacon)return;let i=window.location.origin+"/ia",t=(e=Event.type?Event.type:e,window.location.href,new FormData);t.append("state",e),t.append("location",window.location.href),t.append("referrer",document.referrer),t.append("title",document.title),t.append("origin",window.location.origin);let n=system_time||0;t.append("start_time",n);navigator.sendBeacon(i,t)};sendB("started");var pageVisibility=document.visibilityState;document.addEventListener("visibilitychange",function(){"hidden"===document.visibilityState&&sendB("hidden"),"visible"===document.visibilityState&&sendB("visible")});