...
class Home extends CI_Controller
{
	...
	public function index()
	{
		...
		if($continue) {
			...
			$select = 'at_id, at_summary, at_title, at_segment, at_date_posted, at_date_updated, at_image, at_show_main_image,sc_name,sc_value,at_hits, at_enabled,at_featured';
