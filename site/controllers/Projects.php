...
class Projects extends CI_Controller
{
	...
	{
		$this->pc->page_control( 'projects', 10 );
		
		$where = array( 'at_enabled'=>1, 'at_section'=>6 );
		...
		$this->data['innertitle'] = 'Projects';
		$this->load->view( "{$this->data['theme']}/projects.tpl", $this->data );
	}
	...
	public function i($id=FALSE)
	{
		...
		{
			$where = array( 'at_section'=>6, 'at_id'=>$id );
