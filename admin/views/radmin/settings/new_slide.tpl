...
<div class="col-sm-12">
	<ul class="breadcrumb">
		<li><?php echo anchor( 'home', '<i class="radmin-icon radmin-home"></i>Dashboard' );?></li>
		<li><?php echo anchor( 'settings', '<i class="radmin-icon radmin-cog"></i>Settings' );?></li>
		<li class="active"><i class="radmin-icon radmin-picture"></i> Banner Slide</li>
	</ul>
</div> <!-- end of span12 -->
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
						...
						<select name="subtitle_style" class="form-control input-sm">
							<?php if( isset($slider_settings['title_styles']) ) $ta = $slider_settings['title_styles'];
								...
								foreach($ta as $k=>$v):
									...
									$s = ($this->input->post('subtitle_style')==$key)?'selected':'';
									?>
			...
			<div class="form-group">
				<div class="col-sm-7">
					<label>Link</label>
					<input type="text" name="link" class="form-control input-sm" placeholder="http://" value="<?php echo $this->input->post('link')?>">
				</div>
				<div class="col-sm-3">
					<label>Target</label>
					<?php
