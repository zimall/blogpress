...
HesGallery.createDOM = function () {
  ...
  if (this.options.hostedStyles) document.head.innerHTML += "<link rel='stylesheet' href='/scripts/hes-gallery/hes-gallery.min.css'>";
  ...
  this.elements.galery.innerHTML += '<div id="hg-bg"></div><div id="hg-pic-cont"><img id="hg-pic" /><div id="hg-prev-onpic"></div><div id="hg-next-onpic"></div><div id="hg-subtext"></div><div id="hg-howmany"></div></div><button id="hg-prev"></button><button id="hg-next"></button>';
...
HesGallery.show = function (g, i) {
  ...
  const img = document.getElementById('hg-pic');
