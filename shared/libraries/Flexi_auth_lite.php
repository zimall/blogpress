...
class Flexi_auth_lite
{
	...
	{
		$session_name = $this->CI->auth->session_name['user_identifier'];
		return (bool) isset($this->CI->auth->session_data[$session_name]) ? $this->CI->auth->session_data[$session_name] : false;
	}
	...
	{
		$session_name = $this->CI->auth->session_name['logged_in_via_password'];
		return (bool) isset($this->CI->auth->session_data[$session_name]) ? $this->CI->auth->session_data[$session_name] : false;
	}
